...
namespace Vista
{
    ...
    public partial class FrmEventos : Form
    {
        ...
        {
            InitializeComponent();
            this.empresa = new Empresa(GeneradorDeDatos.Rnd.Next(5, 16));
            this.empresa.onFinalizar += this.MostrarMensajeAgradecimiento;
            this.empresa.onFinalizar += this.DesactivarComponentesFormularios;
        }

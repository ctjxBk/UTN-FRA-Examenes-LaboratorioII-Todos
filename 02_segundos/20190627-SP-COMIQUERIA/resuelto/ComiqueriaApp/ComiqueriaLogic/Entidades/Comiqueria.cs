...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
            ...
            this.productosListChanged?.Invoke();
            this.Productos = Dao.Leer();
        }
        ...
        public void Vender(Producto producto, int cantidad)
        {
            ...
            Serializador<Producto>.SerializarBinario(producto, ruta);
            ...
            Serializador<Producto>.SerializarXML(producto, ruta);
        }
